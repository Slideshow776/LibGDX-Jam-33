...
import no.sandramoen.libgdx33.actors.utils.ShockwaveBackground;
...
public class SplashScreen extends BaseScreen {
    ...
    public void initialize() {
        shockwaveBackground = new ShockwaveBackground("images/excluded/splash landscape.jpg", uiStage);
